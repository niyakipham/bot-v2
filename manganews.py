...
CHANNEL_ID = '1313488880808235120'  # ID của kênh Discord để gửi thông tin

# URL trang web
URL = 'https://kodoani.com/tin-tuc-manga'
...
async def send_to_discord(posts):
    ...
    for post in posts:
        embed = discord.Embed(
            title=post['title'],
            url=post['link'],
            description='THỂ LOẠI: TIN TỨC MANGA',
